...
export default function HelpdeskFeedbackPage() {
  ...
  // Check for current Helpdesk customer and service status
  useEffect(() => {
    const checkCurrentState = async () => {
      try {
        // Check if there's a current queue being served by Helpdesk
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'helpdesk_current_queue') {
        if (e.newValue) {
          try {
      ...
      } else if (e.key === 'helpdesk_service_completed') {
    ...
    const pollInterval = setInterval(() => {
      ...
      if (queueChanged || completionChanged) {
        console.log('Feedback page state updated:', {
          queueChanged,
          completionChanged,
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Loket Helpdesk</h1>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Penilaian Layanan Helpdesk</h1>
            {queueToShow && (
              <div className="mb-4">
            ...
            <p className="text-gray-600 text-lg">
              Bagaimana pengalaman Anda dengan layanan helpdesk pajak hari ini?
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="text-center mt-2">
                <span className="text-sm text-gray-600">
                  {materialMasteryRating === 0 && 'Pilih rating'}
            ...
            <div>
              ...
              <div className="text-center mt-2">
                <span className="text-sm text-gray-600">
                  {communicationRating === 0 && 'Pilih rating'}
            ...
            <button
              type="submit"
              disabled={isSubmitting || rating === 0 || neatnessRating === 0 || materialMasteryRating === 0 || communicationRating === 0}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Loket Helpdesk</h1>
